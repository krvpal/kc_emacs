;;; ~/.doom.d/lisp/auto-capitalize.el -*- lexical-binding: t; -*-
                                       ...
                                       (progn ; beginning of sentence?
                                         ...
                                         (save-restriction
                                           ...
                                           (and (let ((case-fold-search nil))
                                                  (re-search-backward (auto-capitalize-sentence-end)
                                                                      nil t))
                                                (= (match-end 0) text-start)
                                                ;; verify: preceded by
                                                ;; whitespace?
...
;; function to stop auto-capitalize in org-mode src code blocks.
(defun dwiw-auto-capitalize ()
  (when (derived-mode-p 'org-mode) (if (org-in-block-p '("src"))
...
;; the actual function to make org-mode headings and lists work
...
section headings and list items."
  ...
  (setq sentence-end (concat (rx (or
                                  ;; headings
                                  (seq line-start (1+ "*") (1+ space) (? (or "TODO" "DONE" "NEXT" "READY" "WORKING" "WAIT" "SOMEDAY" "OPEN" "CLOSED") (1+ space)))
                                  ;; list and checklist items
                                  (seq line-start (0+ space) "-" (1+ space) (? (or "[ ]" "[X]") (1+ space)))
                                  (seq line-start (0+ space) "+" (1+ space) (? (or "[ ]" "[X]") (1+ space)))
                                  (seq line-start (0+ space) (any "0-9") ")" (1+ space) (? (or "[ ]" "[X]") (1+ space)))
                                  (seq line-start (0+ space) (any "a-z") ")" (1+ space) (? (or "[ ]" "[X]") (1+ space)))
                                  ;; kc start of every line
                                  (seq line-start (0+ space))
                                  ;; kc to work inside org-tables
                                  (seq "|" (0+ space))
                                  ;; kc other situations
                                  (seq "::" (0+ space))
                                  (seq ":" (0+ space))
