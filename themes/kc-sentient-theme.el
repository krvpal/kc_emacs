...
(custom-theme-set-faces
 ...
 '(custom-button ((t (:box (:line-width (1 . 1) :color nil :style nil) :foreground "#268bd2" :background "#000000"))))
 '(custom-button-mouse ((t (:box (:line-width (1 . 1) :color nil :style nil) :foreground "#000000" :background "#268bd2"))))
 '(custom-button-pressed ((t (:box (:line-width (1 . 1) :color nil :style nil) :foreground "#000000" :background "#268bd2"))))
 '(custom-button-pressed-unraised ((t (:box (:line-width (1 . 1) :color nil :style nil) :foreground "#000000" :background "#9c91e4"))))
 '(custom-button-unraised ((t (:box (:line-width (1 . 1) :color nil :style nil) :foreground "#9c91e4" :background "#000000"))))
 ...
 '(ediff-current-diff-A ((t (:weight bold :extend t :background "#4d1b00"))))
 ...
 '(ediff-even-diff-A ((t (:weight bold :extend t :background "black"))))
 ...
 '(ediff-fine-diff-A ((t (:weight bold :background "#8b0000"))))
 ...
 '(emms-browser-album-face ((((class color) (background dark)) (:height 1.1 :bold t :foreground "#f0b144")) (((class color) (background light)) (:height 1.1 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-browser-track-face ((((class color) (background dark)) (:height 1.0 :foreground "#8ec298")) (((class color) (background light)) (:height 1.0 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-browser-artist-face ((((class color) (background dark)) (:height 1.1 :bold t :foreground "#eb4509")) (((class color) (background light)) (:height 1.3 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-playlist-track-face ((((class color) (background dark)) (:height 1.0 :foreground "#8ec298")) (((class color) (background light)) (:foreground "Blue")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "Blue"))))
 '(emms-browser-composer-face ((((class color) (background dark)) (:height 1.0 :bold t :foreground "#aaaaff")) (((class color) (background light)) (:height 1.3 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-browser-performer-face ((((class color) (background dark)) (:height 1.0 :bold t :foreground "#aaaaff")) (((class color) (background light)) (:height 1.3 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-metaplaylist-mode-face ((((class color) (background dark)) (:foreground "AntiqueWhite3")) (((class color) (background light)) (:foreground "red3")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "WhiteSmoke"))))
 '(emms-playlist-selected-face ((((class color) (background dark)) (:foreground "SteelBlue3")) (((class color) (background light)) (:foreground "white" :background "blue3")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "blue3"))))
 '(emms-browser-year/genre-face ((((class color) (background dark)) (:height 1.0 :bold t :foreground "#aaaaff")) (((class color) (background light)) (:height 1.5 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-browser-note-face ((((class color) (background dark)) (:height 1.1 :bold t :foreground "red")) (((class color) (background light)) (:height 1.5 :foreground "#444477")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "#aaaaff"))))
 '(emms-metaplaylist-mode-current-face ((((class color) (background dark)) (:foreground "red2")) (((class color) (background light)) (:foreground "white" :background "red3")) (((type tty) (class mono)) (:inverse-video t)) (t (:background "red3"))))
 )
