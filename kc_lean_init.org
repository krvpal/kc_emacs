...
(use-package ess-view-data
  ...
  (:states '(normal visual)
           :keymaps 'ess-view-data-edit-mode-map
           "SPC m'" #'ess-view-data-do-commit
           "SPC mk" #'ess-view-data-commit-abort
           "SPC ma" #'ess-view-data-insert-all-cols
           "SPC ml" #'ess-view-data-complete-data
           "SPC mv" #'ess-view-data-insert-all-values
           "SPC m <tab>" #'ess-view-data-complete-object
           )
  :config
  (add-to-list 'display-buffer-alist
               '("^\\*R Data View:.*"
